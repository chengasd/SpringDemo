 ...
 */
public class AES {
    private static final String encodeRules = "jiogjowofnjndqewufejhprughefpjwopiejdasncisjkef";
    ...
    public static String AESDecode(String content) {
        try {
            ...
            return AES_decode;
        } catch (NoSuchAlgorithmException | IllegalBlockSizeException | IOException | InvalidKeyException | NoSuchPaddingException | BadPaddingException e) {
